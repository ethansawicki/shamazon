...
namespace Shamazon.DBUtils
{
    public static class DbUtils
    {
        ...
        public static int? GetNullInt(SqlDataReader reader, string column)
        {
            var ordinal = reader.GetOrdinal(column);
            if (reader.IsDBNull(ordinal))
            {
        ...
        public static bool IsNotNull(SqlDataReader reader, string column)
        {
